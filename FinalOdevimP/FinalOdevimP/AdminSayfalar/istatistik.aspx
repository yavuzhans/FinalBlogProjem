<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="istatistik.aspx.cs" Inherits="FinalOdevimP.AdminSayfalar.istatistik" %>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <td> Toplam Dizi Sayısı <asp:Label ID="Label4" runat="server" Text="Label"></asp:Label></td>
                ...
                <td>En Fazla Yorum Alan Blog <asp:Label ID="Label6" runat="server" Text="Label"></asp:Label></td>
