<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="BlogDetay.aspx.cs" Inherits="FinalOdevimP.BlogDetay" %>
                        ...
                        <ItemTemplate>
                            <ul class="comment-list">
                                ...
                                <li>
                                    ...
                                    <div class="desc">
                                        <p style="font-weight: bold"><%# Eval("KULLANICIAD")%> </p>:<p> <%# Eval("YORUMICERIK")%></p>
                                    </div>
